...
@section('title', 'Create Job Listing - Admin')
@section('page_title', 'Create Job Listing')
        ...
        <form action="{{ route('admin.careers.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="short_description" id="short_description" rows="2" required
                    ...
                    placeholder="Brief summary of the position (max 500 characters)">{{ old('short_description') }}</textarea>
            ...
            <div>
                ...
                <textarea name="responsibilities" id="responsibilities" rows="4"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    placeholder="List the key responsibilities...">{{ old('responsibilities') }}</textarea>
