...
<div class="max-w-4xl">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mt-2">Edit Industry: {{ $industry->name }}</h1>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="mb-2">
                        <img src="{{ Storage::url($industry->featured_image) }}" alt="{{ $industry->name }}" class="h-32 w-auto rounded-lg object-cover">
                ...
                <div>
                    ...
                    <textarea name="short_description" id="short_description" rows="2" required
                        ...
                        placeholder="Brief summary for listings (max 500 characters)">{{ old('short_description', $industry->short_description) }}</textarea>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <textarea name="content" id="content" rows="6"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Detailed industry description">{{ old('content', $industry->content) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="challenges" id="challenges" rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="What challenges does this industry face?">{{ old('challenges', $industry->challenges) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="solutions" id="solutions" rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="How do we help solve these challenges?">{{ old('solutions', $industry->solutions) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $industry->meta_title) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <textarea name="meta_description" id="meta_description" rows="2"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="SEO description (defaults to short description)">{{ old('meta_description', $industry->meta_description) }}</textarea>
                </div>
            </div>
        </div>
