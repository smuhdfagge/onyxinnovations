            ...
            <div class="space-y-4">
                <div>
                    ...
                    <textarea name="problem_statement" id="problem_statement" rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="What problem does this service solve?">{{ old('problem_statement') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="solution_approach" id="solution_approach" rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="How do we approach the solution?">{{ old('solution_approach') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="business_value" id="business_value" rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="What business value does this provide?">{{ old('business_value') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="use_cases" id="use_cases" rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Example use cases for this service">{{ old('use_cases') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="content" id="content" rows="8"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Detailed service description">{{ old('content') }}</textarea>
                </div>
            </div>
        </div>
