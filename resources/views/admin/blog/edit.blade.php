...
<div class="max-w-4xl">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mt-2">Edit Post</h1>
    ...
    <form action="{{ route('admin.blog.update', $blog) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="mb-2">
                        <img src="{{ Storage::url($blog->featured_image) }}" alt="{{ $blog->title }}" class="h-32 w-auto rounded-lg object-cover">
                    </div>
                    @endif
                ...
                <div>
                    ...
                    <textarea name="excerpt" id="excerpt" rows="2"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('excerpt', $blog->excerpt) }}</textarea>
                </div>

                <div>
                    <label for="content" class="block text-sm font-medium text-gray-700 mb-1">Content *</label>
                    <textarea name="content" id="content" rows="15" required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('content') border-red-500 @enderror">{{ old('content', $blog->content) }}</textarea>
                    @error('content')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="tags" id="tags" value="{{ old('tags', $blog->tags->pluck('tag')->implode(', ')) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="meta_description" id="meta_description" rows="2"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('meta_description', $blog->meta_description) }}</textarea>
                </div>
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('blog.show', $blog) }}" target="_blank" class="text-gray-500 hover:text-gray-700">
