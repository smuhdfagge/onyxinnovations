...
@section('title', 'Create Portfolio Project - Admin')
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <textarea name="challenge" id="challenge" rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="What problems did the client face?">{{ old('challenge') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="solution" id="solution" rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="How did we solve the problem?">{{ old('solution') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="results" id="results" rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="What outcomes were achieved?">{{ old('results') }}</textarea>
                </div>
            </div>
        </div>
