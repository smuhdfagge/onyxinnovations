...
@section('title', 'Onyx Innovations Ltd - Your Trusted Technology Partner')
...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="absolute inset-0">
        <img src="{{ asset('cover.jpg') }}" alt="Hero Background" class="w-full h-full object-cover">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <a href="{{ route('contact') }}?type=demo" class="inline-flex items-center justify-center px-8 py-4 bg-white text-blue-900 rounded-full font-semibold text-lg hover:bg-blue-50 transition-all shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
            ...
            <a href="{{ route('contact') }}?type=partnership" class="inline-flex items-center justify-center px-8 py-4 bg-transparent border-2 border-white text-white rounded-full font-semibold text-lg hover:bg-white hover:text-blue-900 transition-all">
                Partner With Us
            </a>
            <a href="{{ route('contact') }}" class="inline-flex items-center justify-center px-8 py-4 bg-blue-600 text-white rounded-full font-semibold text-lg hover:bg-blue-700 transition-all">
                Contact Us
            </a>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            <div class="text-center">
                <div class="text-4xl md:text-5xl font-bold text-white mb-2">{{ $stats['projects'] }}+</div>
                <div class="text-blue-200">Projects Delivered</div>
            </div>
            <div class="text-center">
                <div class="text-4xl md:text-5xl font-bold text-white mb-2">{{ $stats['clients'] }}+</div>
                <div class="text-blue-200">Happy Clients</div>
            </div>
            <div class="text-center">
                <div class="text-4xl md:text-5xl font-bold text-white mb-2">{{ $stats['sectors'] }}+</div>
                <div class="text-blue-200">Sectors Served</div>
            </div>
            <div class="text-center">
                <div class="text-4xl md:text-5xl font-bold text-white mb-2">{{ $stats['years'] }}+</div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group border border-gray-100">
                ...
                <p class="text-gray-600 mb-4 leading-relaxed">{{ Str::limit($service->short_description, 120) }}</p>
                <a href="{{ route('services.show', $service) }}" class="inline-flex items-center text-blue-600 font-semibold hover:text-blue-700 group-hover:translate-x-2 transition-transform">
                    Learn More
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group border border-gray-100">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">{{ $defaultService['title'] }}</h3>
                <p class="text-gray-600 mb-4 leading-relaxed">{{ $defaultService['desc'] }}</p>
                <a href="{{ route('services.index') }}" class="inline-flex items-center text-blue-600 font-semibold hover:text-blue-700 group-hover:translate-x-2 transition-transform">
                    Learn More
                    <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
        ...
        <div class="text-center mt-12">
            <a href="{{ route('services.index') }}" class="inline-flex items-center px-8 py-4 bg-blue-600 text-white rounded-full font-semibold hover:bg-blue-700 transition-all shadow-lg">
                View All Services
...
<section class="py-24 bg-gray-900 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-3 md:grid-cols-6 gap-8 items-center opacity-70">
            @foreach(['Laravel', 'React', 'Vue.js', 'Node.js', 'Python', 'AWS', 'Azure', 'Docker', 'PostgreSQL', 'MongoDB', 'Flutter', 'Kubernetes'] as $tech)
...
<section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="group relative overflow-hidden rounded-2xl shadow-lg">
                <div class="aspect-w-16 aspect-h-12">
                    ...
                    <img src="{{ Storage::url($portfolio->featured_image) }}" alt="{{ $portfolio->title }}" class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-500">
                    @else
                    <div class="w-full h-64 bg-gradient-to-br from-blue-600 to-indigo-700 flex items-center justify-center">
                        <span class="text-white text-xl font-semibold">{{ $portfolio->title }}</span>
                    </div>
                    @endif
                </div>
                <div class="absolute inset-0 bg-gradient-to-t from-gray-900/90 via-gray-900/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div class="absolute bottom-0 left-0 right-0 p-6">
                        <h3 class="text-xl font-bold text-white mb-2">{{ $portfolio->title }}</h3>
                        <p class="text-gray-300 text-sm mb-4">{{ Str::limit($portfolio->short_description, 80) }}</p>
                        <a href="{{ route('portfolio.show', $portfolio) }}" class="inline-flex items-center text-blue-400 font-semibold hover:text-blue-300">
                            View Project
                            <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
            ...
            <div class="group relative overflow-hidden rounded-2xl shadow-lg">
                <div class="w-full h-64 bg-gradient-to-br {{ $index % 3 == 0 ? 'from-blue-600 to-indigo-700' : ($index % 3 == 1 ? 'from-indigo-600 to-purple-700' : 'from-cyan-600 to-blue-700') }} flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
                    <span class="text-white/50 text-6xl font-bold">{{ $index + 1 }}</span>
                </div>
                <div class="absolute inset-0 bg-gradient-to-t from-gray-900/90 via-gray-900/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div class="absolute bottom-0 left-0 right-0 p-6">
                        <h3 class="text-xl font-bold text-white mb-2">{{ $item['title'] }}</h3>
                        <p class="text-gray-300 text-sm mb-4">{{ $item['desc'] }}</p>
                        <a href="{{ route('portfolio.index') }}" class="inline-flex items-center text-blue-400 font-semibold hover:text-blue-300">
                            View Project
                            <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
        ...
        <div class="text-center mt-12">
            <a href="{{ route('portfolio.index') }}" class="inline-flex items-center px-8 py-4 border-2 border-blue-600 text-blue-600 rounded-full font-semibold hover:bg-blue-600 hover:text-white transition-all">
                View All Projects
                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                </svg>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <div class="flex items-center">
                    ...
                    <img src="{{ Storage::url($testimonial->client_photo) }}" alt="{{ $testimonial->client_name }}" class="w-12 h-12 rounded-full object-cover">
                    @else
                    <div class="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                        <span class="text-blue-600 font-semibold text-lg">{{ substr($testimonial->client_name, 0, 1) }}</span>
                    </div>
                    @endif
                    <div class="ml-4">
                        <h4 class="font-semibold text-gray-900">{{ $testimonial->client_name }}</h4>
                        <p class="text-gray-500 text-sm">{{ $testimonial->client_position }}, {{ $testimonial->client_company }}</p>
                    </div>
                </div>
            </div>
            @empty
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <p class="text-gray-600 mb-6 italic">"{{ $t['content'] }}"</p>
                <div class="flex items-center">
                    <div class="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                        <span class="text-blue-600 font-semibold text-lg">{{ substr($t['name'], 0, 1) }}</span>
                    </div>
                    <div class="ml-4">
                        <h4 class="font-semibold text-gray-900">{{ $t['name'] }}</h4>
                        <p class="text-gray-500 text-sm">{{ $t['position'] }}, {{ $t['company'] }}</p>
                    </div>
                </div>
            </div>
            @endforeach
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center">
            ...
            <div class="flex items-center justify-center p-4">
                <div class="bg-gray-200 rounded-lg h-12 w-32 flex items-center justify-center text-gray-400 text-sm">Client {{ $i }}</div>
            </div>
            @endfor
            @endforelse
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <a href="{{ route('investors') }}" class="inline-flex items-center px-8 py-4 bg-white text-blue-600 rounded-full font-semibold hover:bg-blue-50 transition-all shadow-lg">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <article class="bg-white rounded-2xl overflow-hidden shadow-lg group">
                ...
                <div class="p-6">
                    @if($post->category)
                    <span class="text-blue-600 text-sm font-semibold">{{ $post->category->name }}</span>
                    @endif
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-gray-400 text-sm">{{ $post->reading_time }}</span>
                    </div>
                </div>
            </article>
            @empty
        ...
        <div class="text-center mt-12">
            <a href="{{ route('blog.index') }}" class="inline-flex items-center px-8 py-4 border-2 border-blue-600 text-blue-600 rounded-full font-semibold hover:bg-blue-600 hover:text-white transition-all">
                View All Articles
                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                </svg>
...
<section class="py-24 bg-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('contact') }}" class="inline-flex items-center justify-center px-8 py-4 bg-blue-600 text-white rounded-full font-semibold text-lg hover:bg-blue-700 transition-all shadow-lg">
                Get Started Today
                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                </svg>
            </a>
            <a href="{{ route('services.index') }}" class="inline-flex items-center justify-center px-8 py-4 border-2 border-gray-300 text-gray-700 rounded-full font-semibold text-lg hover:border-blue-600 hover:text-blue-600 transition-all">
