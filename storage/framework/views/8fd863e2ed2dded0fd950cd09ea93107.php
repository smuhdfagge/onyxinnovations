...
<?php $__env->startSection('title', 'Investors - Onyx Innovations Ltd'); ?>
<?php $__env->startSection('meta_description', 'Investor relations information for Onyx Innovations Ltd. Access corporate governance, financial reports, and investment opportunities.'); ?>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-gray-50 rounded-2xl p-6 flex items-center justify-between group hover:bg-gray-100 transition-colors">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h3 class="font-semibold text-gray-900"><?php echo e($document->title); ?></h3>
                        <p class="text-sm text-gray-500"><?php echo e($document->category); ?> • <?php echo e($document->created_at->format('M Y')); ?></p>
                    </div>
                </div>
                <a href="<?php echo e(Storage::url($document->file_path)); ?>" target="_blank" class="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            ?>
            <?php $__currentLoopData = $placeholderDocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-gray-50 rounded-2xl p-6 flex items-center justify-between group hover:bg-gray-100 transition-colors">
                <div class="flex items-center space-x-4">
                    <div class="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center">
                        <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500"><?php echo e($doc['category']); ?></p>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\onyxil\resources\views/investors.blade.php ENDPATH**/ ?>