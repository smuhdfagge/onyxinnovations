...
<?php $__env->startSection('title', 'Site Settings - Admin'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0 flex space-x-3">
            <a href="<?php echo e(route('admin.partners.index')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-gray-50 transition-colors">
                Partners
            </a>
            <a href="<?php echo e(route('admin.testimonials.index')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-gray-50 transition-colors">
                Testimonials
            </a>
            <a href="<?php echo e(route('admin.investor-documents.index')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-gray-50 transition-colors">
                Investor Docs
            </a>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="settings[site_name]" id="site_name" 
                        value="<?php echo e($settings['general']['site_name']->value ?? 'Onyx Innovations Ltd'); ?>"
                ...
                <div>
                    ...
                    <input type="text" name="settings[site_tagline]" id="site_tagline" 
                        value="<?php echo e($settings['general']['site_tagline']->value ?? 'Your Trusted Technology Partner'); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div class="md:col-span-2">
                    ...
                    <textarea name="settings[site_description]" id="site_description" rows="3"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?php echo e($settings['general']['site_description']->value ?? ''); ?></textarea>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="email" name="settings[contact_email]" id="contact_email" 
                        value="<?php echo e($settings['contact']['contact_email']->value ?? ''); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    ...
                    <input type="text" name="settings[contact_phone]" id="contact_phone" 
                        value="<?php echo e($settings['contact']['contact_phone']->value ?? ''); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div class="md:col-span-2">
                    ...
                    <textarea name="settings[contact_address]" id="contact_address" rows="2"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?php echo e($settings['contact']['contact_address']->value ?? ''); ?></textarea>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="url" name="settings[social_facebook]" id="social_facebook" 
                        value="<?php echo e($settings['social']['social_facebook']->value ?? ''); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <input type="url" name="settings[social_twitter]" id="social_twitter" 
                        value="<?php echo e($settings['social']['social_twitter']->value ?? ''); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <input type="url" name="settings[social_linkedin]" id="social_linkedin" 
                        value="<?php echo e($settings['social']['social_linkedin']->value ?? ''); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <input type="url" name="settings[social_instagram]" id="social_instagram" 
                        value="<?php echo e($settings['social']['social_instagram']->value ?? ''); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <input type="url" name="settings[social_youtube]" id="social_youtube" 
                        value="<?php echo e($settings['social']['social_youtube']->value ?? ''); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <input type="url" name="settings[social_github]" id="social_github" 
                        value="<?php echo e($settings['social']['social_github']->value ?? ''); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div>
                    ...
                    <input type="number" name="settings[stats_projects]" id="stats_projects" 
                        value="<?php echo e($settings['stats']['stats_projects']->value ?? '150'); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    ...
                    <input type="number" name="settings[stats_clients]" id="stats_clients" 
                        value="<?php echo e($settings['stats']['stats_clients']->value ?? '50'); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    ...
                    <input type="number" name="settings[stats_sectors]" id="stats_sectors" 
                        value="<?php echo e($settings['stats']['stats_sectors']->value ?? '10'); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    ...
                    <input type="number" name="settings[stats_years]" id="stats_years" 
                        value="<?php echo e($settings['stats']['stats_years']->value ?? '8'); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\onyxil\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>