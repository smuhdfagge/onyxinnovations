...
<?php $__env->startSection('title', 'Add Team Member - Admin'); ?>
<?php $__env->startSection('page_title', 'Add Team Member'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <a href="<?php echo e(route('admin.team.index')); ?>" class="inline-flex items-center text-gray-600 hover:text-gray-900">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <form action="<?php echo e(route('admin.team.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="position" id="position" value="<?php echo e(old('position')); ?>" required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['position'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="bio" id="bio" rows="4"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Brief biography..."><?php echo e(old('bio')); ?></textarea>
                <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="url" name="linkedin" id="linkedin" value="<?php echo e(old('linkedin')); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="url" name="twitter" id="twitter" value="<?php echo e(old('twitter')); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center space-x-6">
                <label class="flex items-center">
                    ...
                    <input type="checkbox" name="is_leadership" value="1" <?php echo e(old('is_leadership') ? 'checked' : ''); ?>
            ...
            <div class="flex justify-end space-x-4 pt-6 border-t">
                <a href="<?php echo e(route('admin.team.index')); ?>" class="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-gray-50 transition-colors">
                    Cancel
                </a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\onyxil\resources\views/admin/team/create.blade.php ENDPATH**/ ?>