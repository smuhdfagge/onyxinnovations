...
<?php $__env->startSection('page_title', 'Create Service'); ?>
...
<div class="max-w-4xl">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mt-2">Create New Service</h1>
    </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <textarea name="problem_statement" id="problem_statement" rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="What problem does this service solve?"><?php echo e(old('problem_statement')); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="solution_approach" id="solution_approach" rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="How do we approach the solution?"><?php echo e(old('solution_approach')); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="business_value" id="business_value" rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="What business value does this provide?"><?php echo e(old('business_value')); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="use_cases" id="use_cases" rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Example use cases for this service"><?php echo e(old('use_cases')); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="content" id="content" rows="8"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Detailed service description"><?php echo e(old('content')); ?></textarea>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\onyxil\resources\views/admin/services/create.blade.php ENDPATH**/ ?>